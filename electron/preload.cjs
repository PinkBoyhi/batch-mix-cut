...
const api = {
  ...
  retryRemoteFailures: (taskId) => ipcRenderer.invoke("remote:retry", taskId),
  ...
  disposeTask: (taskId) => ipcRenderer.invoke("task:dispose", taskId),
  revealPath: (targetPath) => ipcRenderer.invoke("shell:reveal-path", targetPath),
  openExternal: (url) => ipcRenderer.invoke("shell:open-external", url),
  checkForUpdates: (taskId) => ipcRenderer.invoke("update:check", taskId),
