...
- 第一次安装：手动发送对应平台安装包。
- 后续更新：在软件左侧“更新”区域点击“检查更新”。
- 发现新版本后点击“下载新版”，软件会在后台下载并显示进度。
- 下载完成后点击“重启安装”，软件会自动替换为新版本。
...
- macOS 安装包当前没有 Apple 开发者签名，首次打开可能需要右键“打开”，或到“系统设置 > 隐私与安全性”里允许；未签名状态下自动替换可能被系统拦截。
